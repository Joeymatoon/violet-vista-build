...
const Login = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    toast({
      title: "Welcome back!",
      description: "You have successfully logged in to GigScholars.",
    });
  };
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-primary flex-col justify-center px-12 text-primary-foreground">
        <div className="max-w-md">
          ...
          <h1 className="text-4xl font-bold mb-6 leading-tight">
            Welcome back to your talent journey.
          </h1>
          
          <div className="space-y-2 text-primary-foreground/90">
            <p>Connect with opportunities worldwide.</p>
            <p>Your next project is just a login away.</p>
          </div>
            ...
            <div className="bg-primary-foreground/10 rounded-lg p-4 max-w-xs">
              <div className="flex items-center space-x-3">
                ...
                <div className="flex-1">
                  <div className="h-2 bg-primary-foreground/30 rounded mb-2"></div>
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              ...
              <div className="flex items-center space-x-1">
                <span className="text-sm text-muted-foreground">Join 10,000 talents</span>
                <div className="flex -space-x-1">
                  <div className="w-6 h-6 bg-muted rounded-full border-2 border-background"></div>
                  <div className="w-6 h-6 bg-muted rounded-full border-2 border-background"></div>
                  <div className="w-6 h-6 bg-muted rounded-full border-2 border-background"></div>
                </div>
              </div>
